<x-layout-5>
    <div class="container-fluid bg-secondary right-side p-4 m-auto">
        <span class="d-inline-block bg-primary w-100 my-3 p-2 myBorder"
        ...
        >
            ...
            Welcome to Backgate (“Company”, “we”, “our”, “us”)! These
            Terms of Service (“Terms”, “Terms of Service”) govern your use
            of our website located at backgate.com (together or
            individually “Service”) operated by darker. Our Privacy Policy
            ...
            please let us know by emailing at backgatecode@gmail.com so we
            can try to find a solution. These Terms apply to all visitors,
            users and others who wish to access or use Service. By using
            ...
            emailing at backgatecode@gmail.com. If you wish to purchase
            ...
            represent and warrant that: (i) you have the legal right to
            use any card(s) or other payment method(s) in connection with
            any Purchase; and that (ii) the information you supply to us
        ...
        >
            <p class="text-white-50">
            Extraction file is used to decrypt the encrypted bank logs for
            our users safety. To get access to this file, link here
            </p>
        </div>
        <div
            class="tab-pane fade"
        ...
        >
            ...
            claim via email to backgatecode@gmail.com, with the subject
            ...
            and/or through Service on your copyright. You may submit a
            ...
            detail): 0.1. an electronic or physical signature of the
            person authorized to act on behalf of the owner of the
            copyright’s interest; 0.2. a description of the copyrighted
            work that you claim has been infringed, including the URL
            (i.e., web page address) of the location where the copyrighted
            work exists or a copy of the copyrighted work; 0.3.
            identification of the URL or other specific location on
            Service where the material that you claim is infringing is
            located; 0.4. your address, telephone number, and email
            address; 0.5. a statement by you that you have a good faith
            belief that the disputed use is not authorized by the
            copyright owner, its agent, or the law; 0.6. a statement by
            ...
            backgatecode@gmail.com. You may provide us either directly at
            backgatecode@gmail.com or via third party sites and tools with
            ...
            and for any purpose. EXCEPT AS PROHIBITED BY LAW, YOU WILL
            HOLD US AND OUR OFFICERS, DIRECTORS, EMPLOYEES, AND AGENTS
            HARMLESS FOR ANY INDIRECT, PUNITIVE, SPECIAL, INCIDENTAL, OR
            CONSEQUENTIAL DAMAGE, HOWEVER IT ARISES (INCLUDING ATTORNEYS’
            FEES AND ALL RELATED COSTS AND EXPENSES OF LITIGATION AND
            ARBITRATION, OR AT TRIAL OR ON APPEAL, IF ANY, WHETHER OR NOT
            LITIGATION OR ARBITRATION IS INSTITUTED), WHETHER IN AN ACTION
            OF CONTRACT, NEGLIGENCE, OR OTHER TORTIOUS ACTION, OR ARISING
            OUT OF OR IN CONNECTION WITH THIS AGREEMENT, INCLUDING WITHOUT
            LIMITATION ANY CLAIM FOR PERSONAL INJURY OR PROPERTY DAMAGE,
            ARISING FROM THIS AGREEMENT AND ANY VIOLATION BY YOU OF ANY
            ...
            IF THERE IS LIABILITY FOUND ON THE PART OF COMPANY, IT WILL BE
            ...
            the laws of russia, which governing law applies to agreement
